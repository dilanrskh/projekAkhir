                                ...
                                <div className='space-y-5 flex flex-col p-5'>
                                    <a href="#">
                                        <img
                                            ...
                                            src={`/storage/${fragrance.foto_produk}`}
                                            alt='/'
                                        />
                                    </a>
                                    <h2 className='a text-md font-semibold font-raleway'>{fragrance.nama_produk}</h2>
                                    <p className='text-md font-robot'>Rp. {fragrance.harga}</p>
                                </div>
                            </div>
                        )
