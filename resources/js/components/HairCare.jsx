                                ...
                                <div className='space-y-5 flex flex-col p-5'>
                                    <a href="#">
                                        <img
                                            ...
                                            src={`/storage/${haircare.foto_produk}`}
                                            alt='/'
                                        />
                                    </a>
                                    <h2 className='a text-md font-semibold font-raleway'>{haircare.nama_produk}</h2>
                                    <p className='text-md font-robot'>Rp. {haircare.harga}</p>
                                </div>
                            </div>
                        )
