                                ...
                                <div className='space-y-5 flex flex-col p-5'>
                                    <a href="#">
                                        <img
                                            ...
                                            src={`/storage/${skincare.foto_produk}`}
                                            alt='/'
                                        />
                                    </a>
                                    <h2 className='a text-md font-semibold font-raleway'>{skincare.nama_produk}</h2>
                                    <p className='text-md font-robot'>Rp. {skincare.harga}</p>
                                </div>
                            </div>
                        )
